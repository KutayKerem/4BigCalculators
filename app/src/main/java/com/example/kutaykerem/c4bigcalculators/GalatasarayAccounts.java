...
public class GalatasarayAccounts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galatasaray_accounts);
    ...
    public void back(View view){
        Intent back = new Intent(GalatasarayAccounts.this, Galatasaray.class);
        startActivity(back);
