...
public class GalatasarayCounter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galatasaray_counter);
    ...
    public void back(View view){
        Intent intent = new Intent(GalatasarayCounter.this,Galatasaray.class);
