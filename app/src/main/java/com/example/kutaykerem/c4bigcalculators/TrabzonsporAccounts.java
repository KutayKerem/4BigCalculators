...
public class TrabzonsporAccounts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trabzonsport_accounts);
    ...
    public void back(View view){
        Intent back = new Intent(TrabzonsporAccounts.this, Trabzonspor.class);
        startActivity(back);
