...
public class BesiktasCounter extends AppCompatActivity {
    TextView sonuc;
    TextView counterGet;
    int counterGetAll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_besiktas_counter);
    ...
    public void back(View view){
        Intent intent = new Intent(BesiktasCounter.this,Besiktas.class);
