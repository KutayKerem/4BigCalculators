...
public class FenerbahceAccounts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fenerbahce_accounts);
    ...
    public void back(View view){
        Intent back = new Intent(FenerbahceAccounts.this, Fenerbahce.class);
        startActivity(back);
